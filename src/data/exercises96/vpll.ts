...
export const VPLL = [
  E(
    ...
    "3-0-2-0",
    60,
    "Thoracic extension + scapular depression against wall",
    false,
    "Improves thoracic spine mobility and lat engagement. Essential for overhead pulling prep.",
    CK(
      [
        "Stand with back against wall, arms extended overhead with backs of hands on wall.",
        "Wall contact",
      ],
      [
        "Slide arms down and elbows toward ribs keeping entire arm in contact with wall.",
        "Lat engagement",
      ],
  ...
  E(
    ...
    "2-1-2-1",
    60,
    "Ground-based; dynamic shoulder extension",
    false,
    "Dynamic shoulder extension in prone position. Activates posterior shoulder chain.",
    CK(
      ["Lie face-down, arms extended overhead, forehead on floor.", "Prone position"],
  ...
  E(
    ...
    "2-1-2-1",
    60,
    "Pronated; rotate palms up behind hip",
    false,
    "Often triggers cramping in underused posterior shoulder fibers. Scapular retraction at top.",
    CK(
      ["Face down, arms extended overhead, thumbs up, forehead hovering.", "Hovering start"],
  ...
  E(
    ...
    "3-0-2-0",
    60,
    "Simultaneous spinal extension + shoulder retraction",
    false,
    "Full posterior chain activation. Simultaneous hip extension and scapular retraction.",
    CK(
      ["Face down, arms extended forward, legs straight. Full body contact.", "Start position"],
      [
        "Lift chest and legs simultaneously. Arms sweep back squeezing shoulder blades.",
        "Full arch",
      ],
  ...
  E(
    "VPLL5",
    "Sliding Floor Lat Pulldown (Knees Assisted)",
    "vpll",
    5,
    M(["lats", "core"]),
    "vertical_pull",
    ...
    "3-0-2-0",
    60,
    "Towel on slick floor; knees-down drag",
    false,
    "Knees-down position reduces resistance. Mimics straight-arm lat pulldown mechanics.",
    CK(
      ["Knees on towels on slick floor. Hands in push-up position.", "Knees-down plank"],
  ...
  E(
    "VPLL6",
    "Sliding Floor Lat Pulldown (Full Plank)",
    "vpll",
    6,
    M(["lats", "core", "shoulders"]),
    "vertical_pull",
    ...
    "4-0-2-0",
    90,
    "Full body drag; bodyweight straight-arm pulldown",
    false,
    "Full bodyweight lat pull. Towels under feet on hardwood/tile. Press hands into floor.",
    CK(
      ["Full plank with feet on towels or sliders. Hands firmly planted.", "Full plank"],
  ...
  E(
    ...
    "4-0-2-0",
    90,
    "Eccentric lat load; sliding forearms forward/back",
    false,
    "Eccentric-focused lat exercise. Shoulder flexion increases lat stretch at full extension.",
    CK(
      ["Start in forearm plank with towels under forearms.", "Forearm plank"],
      [
        "Slide forearms forward extending shoulders, keeping torso rigid. Pull back.",
        "Shoulder glide",
      ],
  ...
  E(
    "VPLL8",
    "Door-Edge Pull-up (Feet Assisted)",
    "vpll",
    8,
    ...
    "3-0-1-0",
    90,
    "Hanging from door; feet lightly assisting",
    false,
    "Feet-assisted pull-up builds lat and bicep strength while reducing total load. Door must be sturdy.",
    CK(
      ["Grip top of sturdy open door. Feet on floor with knees slightly bent.", "Door hang"],
      ["Pull chin toward door top keeping feet lightly assisting. Squeeze lats.", "Assisted pull"],
      [
        "Test door stability before full load. Use towel over door for grip/hand protection.",
        "Door safety",
      ],
    ),
  ),
  ...
  E(
    "VPLL9",
    "Sliding One-Arm Floor Lat Pulldown",
    "vpll",
    9,
    M(["lats", "core", "obliques"]),
    ...
    "4-0-2-0",
    90,
    "Unilateral sliding drag; max lat isolation",
    true,
    "Unilateral sliding intensifies lat isolation while obliques resist rotation.",
    CK(
      ["Side plank variant: one hand planted, feet on slider. Body straight.", "Side start"],
      [
        "Pull with one arm dragging body sideways. Resist rotation through core.",
        "Unilateral pull",
      ],
  ...
  E(
    ...
    "5-0-0-0",
    90,
    "Jump to top; 5-10s slow eccentric lowering",
    false,
    "Eccentric training builds strength faster than concentric. 5-10s negatives build pull-up foundation.",
    CK(
      ["Jump or step to top position with chin above hands. Engage lats.", "Top position"],
      [
        "Lower body as slowly as possible — count 5+ seconds. Fight gravity all the way down.",
        "Slow descent",
      ],
  ...
  E(
    "VPLL11",
    "Strict Door-Edge Pull-up",
    "vpll",
    11,
    M(["lats", "biceps", "grip", "rhomboids"]),
    "vertical_pull",
    ...
    "3-0-1-0",
    120,
    "Full concentric/eccentric pull-up on door",
    false,
    "Full pull-up on door edge. Requires strict form — no kipping or momentum.",
    CK(
      ["Hang from door edge with straight arms. Scapula engaged (shoulders down).", "Dead hang"],
  ...
  E(
    "VPLL12",
    "L-Sit Door-Edge Pull-up",
    "vpll",
    12,
    M(["lats", "biceps", "core", "grip"]),
    "vertical_pull",
    ...
    "3-0-1-0",
    120,
    "L-position removes lower body assistance",
    false,
    "L-position eliminates any lower body momentum. Extreme lat and core demand.",
    CK(
      ["Hang from door edge, then raise legs to 90 degrees in front (L-sit).", "L-hang"],
      ["Pull chin above door edge while maintaining L-position. Lower under control.", "L-pull-up"],
      [
        "Keep legs active and toes pointed. If L-position collapses, return to negatives.",
        "Core engagement",
      ],
    ),
  ),
